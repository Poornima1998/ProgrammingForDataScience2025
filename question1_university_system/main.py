from student import Student, SecureStudentRecord
...
def main():
    ...
    # Enroll courses with prerequisite checking and capacity check
    ...
    # Add GPA per semester with validation
    ...
    secure_record = SecureStudentRecord(s1)
